...
`<epiviz-line-plot>` visualizes measurements on the x-axis and genomic annotations on the y axis.
...
To use, add `<epiviz-line-plot>` in the page

      <epiviz-line-plot></epiviz-line-plot>

@demo demo/index-line-plot.html Example page showing a line plot
*/
/*
...
class EpivizLinePlot extends EpivizChartGridBehavior(EpivizChartRemoveBehavior(EpivizChartColorsBehavior(EpivizChartSettingsBehavior(EpivizChartBehavior(PolymerElement))))) {
  static get template() {
    return html`
