...
`<epiviz-stacked-line-track>` is similar to line track with genomic location on the x-axis 
...
To create a stacked-blocks plot on a HTML page, add
      ...
      <epiviz-stacked-line-track></epiviz-stacked-line-track>
...
$_documentContainer.innerHTML = `<dom-module id="epiviz-stacked-line-track">
    <!--<link rel="import" href="../epiviz-imports/epiviz-common-css.html">-->
    <template>
...
class EpivizStackedLineTrack extends EpivizChartGridBehavior(EpivizChartRemoveBehavior(EpivizChartColorsBehavior(EpivizChartSettingsBehavior(EpivizChartBehavior(PolymerElement))))) {
