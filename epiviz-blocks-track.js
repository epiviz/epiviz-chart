...
To create a blocks track on a HTML page, add
      ...
      <epiviz-blocks-track></epiviz-blocks-track>
...
class EpivizBlocksTrack extends EpivizChartGridBehavior(EpivizChartRemoveBehavior(EpivizChartColorsBehavior(EpivizChartSettingsBehavior(EpivizChartBehavior(PolymerElement))))) {
  static get template() {
    return html`
